...
def test_hash_content_sha256(default_service):
    """Test hashing with SHA256."""
    content = b"test content"
    hash_str = default_service.hash_content(content)
...
def test_collision_aware_upgrade():
    ...
    content1 = b"content1"
    content2 = b"content2"
    service._handle_collision(content1, content2)
    ...
    # Verify upgrade to SHA256
    assert service._settings.algorithm == "sha256"
...
async def test_collision_aware_service_md5():
    ...
    service.store_collision(message1, message2, "md5")
...
async def test_collision_aware_service_sha1():
    ...
    service.store_collision(pdf1_prefix, pdf2_prefix, "sha1")
